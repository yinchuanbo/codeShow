---
title: "15种CSS鼠标滑过图片遮罩层动画效果"
date: 2024-03-31T21:33:27+08:00
type: "pc"
creator: "yinhao"
---
...
<div class="container">
  <div class="bg-items">
    <div
      class="items"
      style="background-image : url('https://picsum.photos/240/160/?image=1082');"
    >
      <div class="one"></div>
      <div class="details">
        <h3>#1</h3>
  ...
  <div class="bg-items">
    <div
      class="items"
      style="background-image : url('https://picsum.photos/240/160/?image=1069');"
    >
      <div class="two"></div>
      <div class="details">
        <h3>#2</h3>
  ...
  <div class="bg-items">
    <div
      class="items"
      style="background-image : url('https://picsum.photos/240/160/?image=1070');"
    >
      <div class="three"></div>
      <div class="details">
        <h3>#3</h3>
  ...
  <div class="bg-items">
    <div
      class="items"
      style="background-image : url('https://picsum.photos/240/160/?image=1043');"
    >
      <div class="four"></div>
      <div class="details">
        <h3>#4</h3>
  ...
  <div class="bg-items">
    <div
      class="items"
      style="background-image : url('https://picsum.photos/240/160/?image=1027');"
    >
      <div class="tl5"></div>
      <div class="br5"></div>
      <div class="details">
  ...
  <div class="bg-items">
    <div
      class="items"
      style="background-image : url('https://picsum.photos/240/160/?image=1025');"
    >
      <div class="tl6"></div>
      <div class="tr6"></div>
      <div class="bl6"></div>
  ...
  <div class="bg-items">
    <div
      class="items"
      style="background-image : url('https://picsum.photos/240/160/?image=1016');"
    >
      <div class="seven"></div>
      <div class="details">
        <h3>#7</h3>
  ...
  <div class="bg-items">
    <div
      class="items"
      style="background-image : url('https://picsum.photos/240/160/?image=1015');"
    >
      <div class="eight"></div>
      <div class="details">
        <h3>#8</h3>
  ...
  <div class="bg-items">
    <div
      class="items"
      style="background-image : url('https://picsum.photos/240/160/?image=998');"
    >
      <div class="nine"></div>
      <div class="details">
        <h3>#9</h3>
  ...
  <div class="bg-items">
    <div
      class="items"
      style="background-image : url('https://picsum.photos/240/160/?image=999');"
    >
  ...
  <div class="bg-items">
    <div
      class="items"
      style="background-image : url('https://picsum.photos/240/160/?image=976');"
    >
  ...
  <div class="bg-items">
    <div
      class="items"
      style="background-image : url('https://picsum.photos/240/160/?image=950');"
    >
  ...
  <div class="bg-items">
    <div
      class="items"
      style="background-image : url('https://picsum.photos/240/160/?image=947');"
    >
  ...
  <div class="bg-items">
    <div
      class="items"
      style="background-image : url('https://picsum.photos/240/160/?image=941');"
    >
      <div class="t"></div>
      <div class="r"></div>
      <div class="b"></div>
