---
title: "Card"
date: 2024-05-01T22:46:47+08:00
type: "pc"
creator: "yinhao"
---
...
<div class="parent">
  <div class="card">
    ...
    <div class="content">
      ...
      <span class="text"
        >Create, share, and use beautiful custom elements made with CSS</span
      >
    </div>
    <div class="bottom">
...
.card {
  ...
  box-shadow: rgba(5, 71, 17, 0) 40px 50px 25px -40px, rgba(5, 71, 17, 0.2) 0px 25px
      25px -5px;
}
...
.parent:hover .card {
  ...
  box-shadow: rgba(5, 71, 17, 0.3) 30px 50px 25px -40px, rgba(5, 71, 17, 0.1) 0px
      25px 30px 0px;
}
