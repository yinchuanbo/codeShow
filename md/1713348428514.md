...
date: 2024-04-17T18:07:08+08:00
type: "pc"
creator: "YinHao"
---
  ...
  <div class="content__inner">
    ...
    <div class="icon-block">
      ...
      <div class="signal-icon icon">
        ...
        >
          <path
            class="signal signal--sm"
            fill="#fff"
            stroke="#000"
            stroke-width="3"
            d="m422.586 85.984a42.127 42.127 0 0 0 -22.26-6.96 6 6 0 0 0 -.287 12 30.132 30.132 0 0 1 15.928 4.973 28.881 28.881 0 0 1 12.582 18.974 29.8 29.8 0 0 1 -1.726 16.691 6 6 0 1 0 11.114 4.526 41.772 41.772 0 0 0 2.411-23.4 40.791 40.791 0 0 0 -17.762-26.804z"
          ></path>
          <path
            ...
            stroke="#000"
            stroke-width="3"
            d="m444.156 59.57a69 69 0 0 0 -35-11.34 6 6 0 1 0 -.531 11.989 56.984 56.984 0 0 1 28.911 9.361 55.114 55.114 0 0 1 19.464 22.375 56.478 56.478 0 0 1 -1.773 51.231 6 6 0 1 0 10.513 5.785 68.509 68.509 0 0 0 2.108-62.147 67.114 67.114 0 0 0 -23.692-27.254z"
          ></path>
          <path
            class="signal signal--lg"
            fill="#fff"
            stroke="#000"
            stroke-width="3"
            d="m465.391 33.644a94.837 94.837 0 0 0 -58.084-15.6 6 6 0 1 0 .67 11.98 82.972 82.972 0 0 1 50.794 13.625 80.683 80.683 0 0 1 33.038 44.863 83.017 83.017 0 0 1 -9.1 66.031 6 6 0 1 0 10.244 6.248 95.042 95.042 0 0 0 10.381-75.6 92.691 92.691 0 0 0 -37.943-51.547z"
          ></path>
          <path
            class="signal-body"
            fill="#fff"
      ...
      <div class="rocket-icon icon">
        ...
        >
          ...
          <path
            ...
            stroke="#000"
            stroke-width="3"
            d="m176.345 448.711a6 6 0 0 0 8.42-1.049l28.035-36.011a6 6 0 1 0 -9.469-7.371l-28.031 36.011a6 6 0 0 0 1.045 8.42z"
          ></path>
          <path
            class="rocket-smoke"
            fill="#fff"
            stroke="#000"
            stroke-width="3"
            d="m170.972 455.611a6 6 0 0 0 -8.42 1.049l-8.071 10.367a6 6 0 1 0 9.469 7.371l8.071-10.367a6 6 0 0 0 -1.049-8.42z"
          ></path>
          <path
            class="rocket-smoke"
            fill="#fff"
            stroke="#000"
            stroke-width="3"
            d="m177.8 377.34a6 6 0 0 0 -8.42 1.049l-54.29 69.732a6 6 0 1 0 9.469 7.371l54.288-69.732a6 6 0 0 0 -1.047-8.42z"
          ></path>
          <path
            class="rocket-smoke"
            fill="#fff"
            stroke="#000"
            stroke-width="3"
            d="m133.236 364.011a5.99 5.99 0 0 0 4.739-2.315l3.469-4.457a6 6 0 1 0 -9.468-7.371l-3.47 4.457a6 6 0 0 0 4.73 9.686z"
          ></path>
          <path
            class="rocket-smoke"
            fill="#fff"
            stroke="#000"
            stroke-width="3"
            d="m115.958 389.978 2.728-3.5a6 6 0 0 0 -9.469-7.373l-2.728 3.5a6 6 0 0 0 9.469 7.374z"
          ></path>
          <path
            class="rocket-smoke"
            fill="#fff"
            stroke="#000"
            stroke-width="3"
            d="m97.747 403.6a6 6 0 0 0 -8.42 1.048l-6.059 7.784a6 6 0 1 0 9.468 7.371l6.06-7.784a6 6 0 0 0 -1.049-8.419z"
          ></path>
        </svg>
      </div>
      <!--replay btn--><button class="icon-block__replay btn" type="button">
      ...
      <div class="chat-icon icon">
        ...
        >
          ...
          <path
            ...
            stroke="#000"
            stroke-width="3"
            d="M153,163.2c-28.152,0-51,22.848-51,51s22.848,51,51,51s51-22.848,51-51S181.152,163.2,153,163.2z M153,244.8c-16.932,0-30.6-13.668-30.6-30.6s13.668-30.6,30.6-30.6s30.6,13.668,30.6,30.6S169.932,244.8,153,244.8z"
          ></path>
          <path
            class="chat-dot"
            fill="#fff"
            stroke="#000"
            stroke-width="3"
            d="M295.8,163.2c-28.152,0-51,22.848-51,51s22.848,51,51,51s51-22.848,51-51S323.952,163.2,295.8,163.2z M295.8,244.8c-16.932,0-30.6-13.668-30.6-30.6s13.668-30.6,30.6-30.6s30.6,13.668,30.6,30.6S312.732,244.8,295.8,244.8z"
          ></path>
          <path
            class="chat-dot"
            fill="#fff"
            stroke="#000"
            stroke-width="3"
            d="M438.6,163.2c-28.152,0-51,22.848-51,51s22.848,51,51,51c28.152,0,51-22.848,51-51S466.752,163.2,438.6,163.2zM438.6,244.8c-16.932,0-30.6-13.668-30.6-30.6s13.668-30.6,30.6-30.6s30.6,13.668,30.6,30.6S455.532,244.8,438.6,244.8z"
          ></path>
        </svg>
      </div>
      <!--replay btn--><button class="icon-block__replay btn" type="button">
...
const progressReplay =
  document.querySelector(".progress-icon").nextElementSibling;
